...
export const RelatedProductsSection = ({ relatedProducts, categories = [] }) => {
    ...
    <div className="container mx-auto px-4 py-8 mb-8 lg:px-24 xl:px-32">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {displayedProducts.map((relProduct, index) => (
          <Link 
            to={`/product-preview/${relProduct.slug}`}
            ...
            <div className="relative w-full pt-[50%]">
              <div className="absolute inset-0">
                ...
                <div
                  ...
                  style={{
                    backgroundColor: categories.find(cat => cat.name === relProduct.category)?.backgroundColor,
                    color: categories.find(cat => cat.name === relProduct.category)?.textColor
                  }}
                >
                  {relProduct.category}
                </div>
